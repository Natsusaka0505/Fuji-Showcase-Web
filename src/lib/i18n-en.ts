...
export const EN: Record<string, string> = {
  ...
  "本隊": "This team",
  "Fujitsu 模擬器上限 40 qubit。2024 冠軍 TU Delft 用 39q,本隊用滿上限 —— 不只超越去年冠軍,而是打到模擬器天花板。":
    "The Fujitsu simulator caps at 40 qubits. The 2024 champion TU Delft used 39q; this team used the full cap — not just past last year's champion but at the simulator's ceiling.",
